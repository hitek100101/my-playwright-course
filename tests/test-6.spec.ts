...
test('test', async ({ page }) => {
  ...
  await page.getByRole('row', { name: 'Select/deselect item 231 for' }).getByRole('button').click();
  await page.getByRole('button', { name: 'Cancel' }).click();
  await page.getByRole('button', { name: 'Delete' }).nth(4).click();
  await page.getByRole('button', { name: 'Cancel' }).click();
  await page.getByRole('row', { name: 'Select/deselect item 229 for' }).getByRole('button').click();
  await page.getByRole('button', { name: 'Cancel' }).click();
  await page.getByRole('row', { name: 'Select/deselect item 230 for' }).getByRole('button').click();
  await page.getByRole('button', { name: 'Cancel' }).click();
  await page.getByRole('row', { name: 'Select/deselect item 229 for' }).getByRole('button').click();
  await page.getByRole('button', { name: 'Cancel' }).click();
  await page.getByRole('link', { name: 'Edit' }).first().click();
  await page.goto('https://qa.hitekschool.com/lms/3108/users');
